        ...
        <form action="/doUpdateAd.jsp" method="post">
            ...
            <table body="0" cellspacing="0" cellpadding="10" width="90%">
                <tr>
                    ...
                    <td>
                        <input type="text" name="subject" value="${sessionScope.adData.subject}" style="width: 90%">
                    </td>
                </tr>
                <tr>
                    <td>Текст:</td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <input type="submit" class="btn btn-outline-primary mx-1 my-1" value="Сохранить">
                        <%-- При нажатии на кнопку "Отменить" возвращаемся на страницу кабинета --%>
                        <input type="button" class="btn btn-outline-danger mx-1 my-1" value="Отменить" onclick="window.location='<c:url value="/cabinet.jsp" />';">
                    </td>
                </tr>
            </table>
        </form>
